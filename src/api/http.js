...
//     axios.defaults.baseURL = 'http://cscloud-qa.ecs.cscad.net:6003/';
//     // http://cscloud-stg.ecs.cscad.net/
//     // axios.defaults.baseURL = 'http://192.168.100.15:6003/'
// }
...
//     axios.defaults.baseURL = `${origin}:6003/`;
// }
// //axios.defaults.baseURL = 'http://api.volcore.xyz/';
...
function patch (url, params, loading, config) {
    showLoading(loading);
    axios.defaults.headers[_Authorization] = getToken();
    return new Promise((resolve, reject) => {
...
// ajax.patch = function (url, param, success, errror) {
//     ajax({ url: url, param: param, success: success, error: errror, type: 'patch' })
// }
export default { post, get,download, ajax, ipAddress, patch }
